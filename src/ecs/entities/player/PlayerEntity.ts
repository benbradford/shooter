...
export function createPlayerEntity(props: CreatePlayerEntityProps): Entity {
  ...
  animMap.set(`walk_${Direction.Down}`, new Animation(['439', '440', '441', '442'], 'repeat', 0.125));
  animMap.set(`walk_${Direction.DownRight}`, new Animation(['443', '444', '445', '446'], 'repeat', 0.125));
  animMap.set(`walk_${Direction.Right}`, new Animation(['447', '448', '449', '450'], 'repeat', 0.125));
  animMap.set(`walk_${Direction.UpRight}`, new Animation(['451', '452', '453', '454'], 'repeat', 0.125));
  animMap.set(`walk_${Direction.Up}`, new Animation(['455', '456', '457', '458'], 'repeat', 0.125));
  animMap.set(`walk_${Direction.UpLeft}`, new Animation(['459', '460', '461', '462'], 'repeat', 0.125));
  animMap.set(`walk_${Direction.Left}`, new Animation(['463', '464', '465', '466'], 'repeat', 0.125));
  animMap.set(`walk_${Direction.DownLeft}`, new Animation(['467', '468', '469', '470'], 'repeat', 0.125));
  ...
  animMap.set(`slide_${Direction.Down}`, new Animation(['471', '472', '473', '474', '475', '476'], 'once', 0.07));
  animMap.set(`slide_${Direction.DownRight}`, new Animation(['477', '478', '479', '480', '481', '482'], 'once', 0.07));
  animMap.set(`slide_${Direction.Right}`, new Animation(['483', '484', '485', '486', '487', '488'], 'once', 0.07));
  animMap.set(`slide_${Direction.UpRight}`, new Animation(['489', '490', '491', '492', '493', '494'], 'once', 0.07));
  animMap.set(`slide_${Direction.Up}`, new Animation(['495', '496', '497', '498', '499', '500'], 'once', 0.07));
  animMap.set(`slide_${Direction.UpLeft}`, new Animation(['501', '502', '503', '504', '505', '506'], 'once', 0.07));
  animMap.set(`slide_${Direction.Left}`, new Animation(['507', '508', '509', '510', '511', '512'], 'once', 0.07));
  animMap.set(`slide_${Direction.DownLeft}`, new Animation(['513', '514', '515', '516', '517', '518'], 'once', 0.07));

  animMap.set(`uppercut_${Direction.Down}`, new Animation(['327', '328', '329', '330', '331', '332', '333'], 'once', 0.06));
  animMap.set(`uppercut_${Direction.DownRight}`, new Animation(['334', '335', '336', '337', '338', '339', '340'], 'once', 0.06));
  animMap.set(`uppercut_${Direction.Right}`, new Animation(['341', '342', '343', '344', '345', '346', '347'], 'once', 0.06));
  animMap.set(`uppercut_${Direction.UpRight}`, new Animation(['348', '349', '350', '351', '352', '353', '354'], 'once', 0.06));
  animMap.set(`uppercut_${Direction.Up}`, new Animation(['355', '356', '357', '358', '359', '360', '361'], 'once', 0.06));
  animMap.set(`uppercut_${Direction.UpLeft}`, new Animation(['362', '363', '364', '365', '366', '367', '368'], 'once', 0.06));
  animMap.set(`uppercut_${Direction.Left}`, new Animation(['369', '370', '371', '372', '373', '374', '375'], 'once', 0.06));
  animMap.set(`uppercut_${Direction.DownLeft}`, new Animation(['376', '377', '378', '379', '380', '381', '382'], 'once', 0.06));

  animMap.set(`throw_${Direction.Down}`, new Animation(['383', '384', '385', '386', '387', '388', '389'], 'once', 0.08));
  animMap.set(`throw_${Direction.DownRight}`, new Animation(['390', '391', '392', '393', '394', '395', '396'], 'once', 0.08));
  animMap.set(`throw_${Direction.Right}`, new Animation(['397', '398', '399', '400', '401', '402', '403'], 'once', 0.08));
  animMap.set(`throw_${Direction.UpRight}`, new Animation(['404', '405', '406', '407', '408', '409', '410'], 'once', 0.08));
  animMap.set(`throw_${Direction.Up}`, new Animation(['411', '412', '413', '414', '415', '416', '417'], 'once', 0.08));
  animMap.set(`throw_${Direction.UpLeft}`, new Animation(['418', '419', '420', '421', '422', '423', '424'], 'once', 0.08));
  animMap.set(`throw_${Direction.Left}`, new Animation(['425', '426', '427', '428', '429', '430', '431'], 'once', 0.08));
  animMap.set(`throw_${Direction.DownLeft}`, new Animation(['432', '433', '434', '435', '436', '437', '438'], 'once', 0.08));
