...
export function preloadAssets(scene: Phaser.Scene, keys?: AssetKey[]): void {
  const keysToLoad: AssetKey[] = keys ?? ['player', 'attacker', 'floating_robot', 'exclamation', 'bullet_default', 'bullet_default_shell', 'smoke', 'robot_hit_particle', 'crosshair', 'slide_icon', 'fireball', 'fire', 'shadow', 'coin', 'vignette', 'bug', 'bug_base', 'base_destroyed', 'arrows', 'thrower', 'grenade', 'door_closed', 'dungeon_door', 'dungeon_key', 'rock', 'skeleton', 'bone_small', 'stone_stairs', 'stone_wall', 'stone_floor', 'dungeon_floor', 'dungeon_overlays', 'wall_torch', 'pillar', 'dungeon_vase'];
