...
export function preloadAssets(scene: Phaser.Scene, keys?: AssetKey[]): void {
  const keysToLoad: AssetKey[] = keys || ['player', 'floating_robot', 'exclamation', 'bullet_default', 'bullet_default_shell', 'smoke', 'robot_hit_particle', 'crosshair', 'fireball', 'fire', 'shadow', 'vignette', 'dungeon_floor01', 'dungeon_floor02', 'bug', 'bug_base'];
