...
export class AddBulletDudeEditorState extends EditorState {
  ...
  onEnter(): void {
    ...
    this.ghostSprite = gameScene.add.sprite(0, 0, 'player', 0);
  ...
  private readonly handlePointerDown = (pointer: Phaser.Input.Pointer): void => {
    ...
    levelData.bulletDudes ??= [];

    levelData.bulletDudes.push({
      col: cell.col,
      row: cell.row,
    ...
    this.scene.enterEditBulletDudeMode(newBulletDude);
  };
}
