...
**Sheet Dimensions:** 544x408 (8 columns × 6 rows)
...
Frames 4-7 (row 0, cols 4-7) and 45-47 (row 5, cols 5-7) are blank padding.
...
# Stack
magick "$TMPDIR"/row{0,1,2,3,4,5}.png -append knight_spritesheet.png
rm -rf "$TMPDIR"
```
