...
export class ContextPanel {
  ...
  async showStatePanel(): Promise<void> {
    ...
    this.container.querySelector('#st-reset-flags')?.addEventListener('click', () => {
      const resetFlags: Record<string, string> = { canPunch: 'true', canSwim: 'true', canJump: 'true', canPush: 'true', hasSuperPunch: 'true', hasAutoHeal: 'true', hasCompanion: 'false', pet_rock_collected: 'true', pet_dog_collected: 'true', pet_selected: 'rock' };
      const flagsDiv = this.container.querySelector('#st-flags')!;
      flagsDiv.innerHTML = '';
