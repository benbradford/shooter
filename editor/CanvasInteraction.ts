...
export class CanvasInteraction {
  ...
  renderOverlays(): void {
    ...
    const labelMap: Record<string, string> = {
      ...
      bullet_dude: 'BD', puma: 'P', tv_monk: 'TM', npc: 'NPC', breakable: 'BK', pushable: 'PU', hole: 'HO', collectible: 'CO', lever: 'LV', laser: 'LA', escort: 'ES', root_chest: 'RC', worm: 'WM', beetle: 'BT', fly: 'FL', moving_tile: 'MT',
    };
