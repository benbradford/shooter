...
- **Level tool**: Shows Level Info panel with name, size, theme dropdown, music dropdown, player start (editable), fixed camera checkbox + center col/row, resize buttons, and data entities list (interactions, eventchainers, cellmodifiers with add/click-to-edit)
