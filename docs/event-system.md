...
Extend `BaseEventComponent`, call `registerEvent()` in the constructor, implement `onEvent()`.
...
2. **Register in constructor**: Always call `registerEvent()` in the constructor
