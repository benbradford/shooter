...
Store visual elements in a Map and destroy them when no longer needed. Without tracking, deselected items keep visual indicators and memory leaks occur.
...
## Step-by-Step: Adding New Editor Functionality

1. Add tool handling in `editor/CanvasInteraction.ts`
2. Add UI panel/form in `editor/panels/ContextPanel.ts`
3. Add button to toolbar in `editor/panels/Toolbar.ts`
