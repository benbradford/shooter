...
- **New background textures (2026-05-22)**: `dead_tree2`, `dead_tree3` added to `public/assets/cell_drawables/`, registered in `AssetRegistry`, added to `editor` asset group and `BACKGROUND_TEXTURE_KEYS`. Note: `dead_tree3` file pending creation (registered but PNG not yet present).